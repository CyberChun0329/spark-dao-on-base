...
Course and session creation also enforce the teacher-fault solvency rule against the
frozen price and salary: `0.5W + 2 * researchShare * P <= 0.5P`.
...
mints teaching NFTs, and both token minters should be locked after deployment.
