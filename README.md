...
`ResearchGasCalibration.t.sol`; the TypeScript simulation reads the teaching settlement,
teaching claim, and research calibration CSVs, then writes `simulation_outputs/`. Do not
